...
public class Scheduler {
	...
	public void initProcesses(int numOfQueues, ArrayList<Process> processes){
	...
	private static void printContents(ArrayList<Process> processes2) {
		System.out.print("[");
